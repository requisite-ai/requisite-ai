...
| Debate / critic strategies | ✅ — `native` orchestrator only; see [ADR-0011](docs/adr/0011-critic-and-consensus-strategies.md), [ADR-0012](docs/adr/0012-debate-and-map-reduce-strategies.md) |
