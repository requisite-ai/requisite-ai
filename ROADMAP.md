...
| Planner strategy | ✅ — `native` and `langgraph` orchestrators; see [ADR-0007](docs/adr/0007-multi-agent-orchestration-strategies.md), [ADR-0035](docs/adr/0035-langgraph-planner-strategy.md) -- closes this section's last open native-vs-langgraph parity gap, all twelve multi-agent strategies now run on both backends |
